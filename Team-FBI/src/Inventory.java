...
public class Inventory extends JPanel{
	...
	private JLabel lblPlayership;
	private JLabel lblPlayerhull;
	private JLabel lblPlayerCash;
	private JLabel lblPlayerdiff;
	private JLabel lblWaterNum;
	private JLabel lblFoodNum;
	private JLabel lblOreNum;
	private JLabel lblGameNum;
	private JLabel lblFirearmNum;
	private JLabel lblMedNum;
	private JLabel lblMacNum;
	private JLabel lblNarNum;
	private JLabel lblRobNum;
	private JLabel lblFurNum;
	/**
	 * Constructor
	 * @param player
	 */
	public Inventory(Player player) {
		...
		JLabel lblHull = new JLabel("Hull:");
		...
		JLabel lblGames = new JLabel("Game");
		...
		JLabel lblFirearms = new JLabel("Firearm");
		...
		JLabel lblNarcotic = new JLabel("Narcotic");
	...
	public void update(){
		...
		lblPlayerhull.setText(player.getShip().getHull()+"/"+player.getShip().getMaxHull());
